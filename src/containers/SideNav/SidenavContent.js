        ...
        <ul className="nav-menu">
          ...
          <li className="menu collapse-box">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app/account">
          ...
          <li className="menu collapse-box">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app/product">
          ...
          <li className="menu collapse-box">
            <Button>
              <i className="zmdi zmdi-view-dashboard zmdi-hc-fw" />
              <span className="nav-text">Thương Hiệu</span>
            </Button>
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app/brand">
